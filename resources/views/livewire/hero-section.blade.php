...
<div id="hero" class="hero-section relative bg-cover bg-center h-screen min-h-[600px] flex items-center" style="background-image: url('{{ asset('images/bg1.jpg') }}');">
    ...
    <div class="container relative z-10 mx-auto px-6 lg:px-20 flex flex-col justify-center items-start text-white">
        ...
        <h1 class="text-5xl lg:text-6xl font-extrabold leading-tight hero-title">
        ...
        <p class="mt-4 text-lg max-w-xl text-gray-300 leading-relaxed hero-subtext">
        ...
        <div class="mt-6 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="flex items-center space-x-3 hero-feature">
